...
public class FlightPrices {
	...
	public void FlightPrice(String ret, String dep)
	{
		...
		System.out.println("Dep Flight Price final"+prices.get("Dep Flight"));
		System.out.println("Ret Flight Price final"+prices.get("Ret Flight"));
		Long expectedTotal=numericalPrice(prices.get("Dep Flight"))+numericalPrice(prices.get("Ret Flight"));
